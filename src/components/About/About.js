...
import aboutImg01_s from '../../images/light/aboutImg01_small.png';
  ...
  return (
    ...
    <div className={`about`}>
      <div className="dark-box about__block">
        ...
        <img className="dark-box__back-img dark-box__back-img_small" src={aboutImg01_s} alt="workplace"></img>
