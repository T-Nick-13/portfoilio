...
const text1 = (
  <p className="card__text">
    The main theme in my works is
    <br />
    <span>PEOPLE</span>
    . You can find illustrations
    <br />
    about cultural diversity, equality,
    <br />
...
const text6 = (
  <p className="card__text">
    Modern design for any
    <br />
    events
  </p>
);
const text7 = (
  <p className="card__inside-text">
...
const text10 = <p className="card__text">Modern silhouettes of people can showcase the diversity of society</p>;
const text11 = (
  <p className="card__text card__text_inside">
    I like minimalist design.
    <br />
    If you like it too,
    <br />
